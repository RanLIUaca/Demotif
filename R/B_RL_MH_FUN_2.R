...
#' @param A_samp A vector of sampled positions for the first motif.
...
#' @export
#'
B_samp_fun = function(R,W_samp,G_samp,A_samp,motif_len_w,motif_len_g,dict,theta_0_samp,theta_samp,theta_til_samp){
  B_samp_unobs = rep(NA, total_n)
